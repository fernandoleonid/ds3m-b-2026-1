...
## Objetivo
A atividade tem como objetivo consolidar o conteúdo da disciplina de PWFE (Programação web Front-end) e integrar com PWBE (Programação web Back-end) do curso de desenvolvimento de sistemas do SENAI Jandira.

O projeto é o gerenciamento da escola Lion School, deverá ser realizado somente o front-end. 
